  ...
  return (
      ...
      <div className="flex items-center justify-center min-h-screen px-2">
        <div className="text-center">
          ...
          <a href="/"
            className="px-6 py-3 font-semibold transition duration-300 ease-in-out bg-white rounded-full hover:bg-purple-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white">
            Go Back Home
          </a>
        </div>
      </div>
